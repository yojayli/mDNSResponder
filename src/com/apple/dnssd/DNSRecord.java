...
/**
 * Reference to a record returned by {@link DNSSDRegistration#addRecord}.
 * <P>
 * 
 * Note: client is responsible for serializing access to these objects if they
...
public interface DNSRecord {
	 ...
	 * <P>
	 * The record must either be the primary txt record of a service registered
	 * via DNSSD.register(), or a record added to a registered service via
	 * addRecord().
	 * <P>
	 * 
	 * @param flags
