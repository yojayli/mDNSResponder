...
public interface RegisterListener extends BaseListener {
	 ...
	 *            specify a name in DNSSD.register(), this indicates what name
	 *            was automatically chosen).
	 *            <P>
	 * @param regType
	 *            The type of service registered, as it was passed to
	 *            DNSSD.register().
	 *            <P>
	 * @param domain
	 *            The domain on which the service was registered. If the
	 *            application did not specify a domain in DNSSD.register(), this
	 *            is the default domain on which the service was registered.
	 */
	void serviceRegistered(DNSSDRegistration registration, int flags,
