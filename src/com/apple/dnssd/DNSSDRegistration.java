...
public interface DNSSDRegistration extends DNSSDService {
	 ...
	 * <P>
	 * 
	 * @return A {@link DNSRecord}. If {@link DNSSDRegistration#stop} is called,
	 *         the DNSRecord is also invalidated and may not be used further.
	 */
	 ...
	 * <P>
	 * The record can be updated or deregistered by sending it an update() or
	 * remove() message.
	 * <P>
	 * 
	 * @param flags
	 ...
	 *            <P>
	 * @param rrType
	 *            The type of the record (e.g. TXT, SRV, etc), as defined in
	 *            nameser.h.
	 *            <P>
	 * @param rData
	 ...
	 *            <P>
	 * @return A {@link DNSRecord} that may be passed to updateRecord() or
	 *         removeRecord(). If {@link DNSSDRegistration#stop} is called, the
	 *         DNSRecord is also invalidated and may not be used further.
	 */
