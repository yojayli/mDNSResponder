...
public interface DomainListener extends BaseListener {
	 ...
	 *            <P>
	 * @param ifIndex
	 *            Specifies the interface on which the domain exists. (The index
	 ...
	 */
	void domainFound(DNSSDService domainEnum, int flags, int ifIndex,
			String domain);
	 ...
	 *            The name of the domain.
	 */
	void domainLost(DNSSDService domainEnum, int flags, int ifIndex,
			String domain);
}
